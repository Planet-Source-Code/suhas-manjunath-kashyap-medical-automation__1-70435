...
Begin {C0E45035-5775-11D0-B388-00A0C9055D8E} DataEnvironment 
   ...
   _ExtentY        =   4048
   FolderFlags     =   5
   TypeLibGuid     =   "{39ABE428-509D-435D-85B4-4C29A9A0E3CF}"
   TypeInfoGuid    =   "{FEED744C-EA3C-4457-AD42-37C4C95C10CC}"
   TypeInfoCookie  =   0
   Version         =   4
   NumConnections  =   1
   BeginProperty Connection1 
      ...
      ConnDispId      =   1001
      SourceOfData    =   3
      ConnectionSource=   "Provider=Microsoft.Jet.OLEDB.4.0;Data Source=D:\V.B PROJECT\MEDICAL_AUTOMATIONS\DATABASE\HOSPITAL.MDB;Persist Security Info=False"
      Expanded        =   -1  'True
      QuoteChar       =   96
      SeparatorChar   =   46
   EndProperty
